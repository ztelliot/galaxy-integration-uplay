...
class BackendClientMock(AsyncMock):
    ...
    async def get_user_data(self):
        return {'userId': '123', 'username': 'Mock', 'nameOnPlatform': 'MockPl', 'accountIssues': None, 'communicationOptIn': True, 'communicationThirdPartyOptIn': False, 'country': 'US', 'dateCreated': '2017-11-06T17:57:05.9770000Z', 'dateOfBirth': '1990-01-01T00:00:00.0000000Z', 'email': 'mocker@gmail.com', 'firstName': None, 'gender': None, 'hasAcceptedLegalOptins': True, 'lastName': None, 'preferredLanguage': 'en', 'status': {'autoGeneratedUsername': False, 'dateOfBirthApproximated': False, 'invalidEmail': False, 'missingRequiredInformation': False, 'pendingDeactivation': False, 'recoveringPassword': False, 'passwordUpdateRequired': False, 'reserved': False, 'changeEmailPending': False, 'inactiveAccount': False, 'generalStatus': 'activated', 'suspiciousActivity': False, 'locked': False}, 'accountType': 'Ubisoft'}
